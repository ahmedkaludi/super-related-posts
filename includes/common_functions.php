...
function ppl_sort_items($sort, $results, $option_key, $items) {
...
function ppl_post_filter_1($content) {
	global $ppl_filter_data;
...
function ppl_post_filter_2($content) {
	global $ppl_filter_data2;
	foreach ($ppl_filter_data2 as $data) {
		if($data['position'] == 'atc'){
...
function ppl_post_filter_3($content) {
	global $ppl_filter_data3;
	foreach ($ppl_filter_data3 as $data) {
		if($data['position'] == 'atc'){
...
add_action ('init', 'ppl_post_filter_init1');
add_action ('init', 'ppl_post_filter_init2');
add_action ('init', 'ppl_post_filter_init3');
